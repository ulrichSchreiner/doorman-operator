...
VERSION ?= 0.0.1
REPO_PREFIX ?= quay.io/ulrichschreiner/doorman

# Default bundle image tag
BUNDLE_IMG ?= $(REPO_PREFIX)-controller-bundle:$(VERSION)
...
IMG ?= $(REPO_PREFIX)-controller:latest
...
.PHONY:
minikube-deployment:
	ANSIBLE_INVENTORY=local/minikube \
	ANSIBLE_ROLES_PATH=/work/roles \
	ansible-playbook \
		-vv \
		local/minikube-play.yml
